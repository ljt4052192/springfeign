...
<table id="logListTable" lay-filter="logList"></table>
<script type="text/html" id="barDemolog">
    <%--    <a class="layui-btn layui-btn-primary layui-btn-mini" lay-event="detail">查看</a>--%>
    <a class="layui-btn layui-btn-mini" lay-event="edit">编辑</a>
    <a class="layui-btn layui-btn-danger layui-btn-mini" lay-event="del">删除</a>
</script>

<script type="text/html" id="barDemoLog2">
    <%--    <a class="layui-btn layui-btn-primary layui-btn-mini" lay-event="detail">查看</a>--%>
...
<script>
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,height: 468
            ,height: 468
            ,url: "../log/selectLogList" //数据接口
            ,toolbar:"#barDemoLog2"
            ,page: true //开启分页
            ,cols: [[ //表头
                {checkbox: "userListBox", fixed: true}
                ,{field: 'id', title: 'ID', width:60, sort: true, fixed: 'left'}
                ,{field: 'log', title: '日志方法', width:90}
                ,{field: 'ipAddress', title: 'IP地址', width:120}
                ,{field: 'name', title: '日志名称', width:90}
                ,{field: 'ip', title: 'ip', width:80, sort: true}
                ,{field: 'logTime', title: '创建时间', width:160}
                ,{field: 'requestMsg', title: '请求参数', width: 170}
                ,{field: 'responseMsg', title: '回想参数', width: 100, sort: true}
                ,{field:'right',width:160, title: '操作', toolbar:"#barDemolog"}
